...
<div ng-controller="artikli" class="prikaz" id="wrapper-izvjesce">
	<div ng-controller="izvjesce">
		...
		<div id="mySidenav" class="sidenav">
			...
			<a href="#!/izvjesce" class="active">Izvješće Artikala</a>
		...
		<div id="main">
			...
			<div id="pretraga">
				<form>
			      	<select id="artikliOdabir" class="form-control" style="width: 500px;" ng-init="IzvjesceIspis2()">
			      		<option value="-1"></option>
			      	</select>
			      	<button id="btnSubmit" class="btn btn-primary" ng-click="IzvjesceIspis2(); PrikaziPretragu()" type="button">Submit</button>
			    </form>
			</div>
			<div id="pretragaDokumenta" hidden>
				<div id="select2">
					<form>
			...
			<div id="tablicaIzvjesce"  style="overflow-y:auto;">
				<table>
					<thead>
						<tr>
							<th>Tip dokumenta</th>
					...
					<tbody>
						<tr ng-repeat="dokument in lIzvjesce | myFilter:startDate | myFilter2:endDate |filter:unos | orderBy:'dokument_datum'">
