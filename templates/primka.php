...
<div ng-controller="artikli">
	<div ng-controller="primka">
		<div id="mySidenav" class="sidenav">
			...
			<a href="#!/primka" class="active">Nova Primka</a>
		...
		<div id="main">
			...
			<div id="naruci">
				<div id="BtnDodaj">
					<button class="btn btn-success" type="submit" value="Submit" ng-click="getData()">Dodaj Primku</button>
				</div>
